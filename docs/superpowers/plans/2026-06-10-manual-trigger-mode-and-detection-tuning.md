...
- [x] **Step 3: 重写 `core/change_detector.py`**
...
- [x] **Step 3: 改 `ui/translation_overlay.py`**
...
- [x] **Step 2: 改 worker 构造,加 get_auto**
